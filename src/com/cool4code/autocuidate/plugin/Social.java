package com.cool4code.autocuidate.plugin;
...
public class Social extends CordovaPlugin {
	...
	private void share(String message, File imageFile, CallbackContext callbackContext) {
		try {
			...
			sendIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Autocuidate - Porque tu primera responsabilidad eres tu!");
